...
<body>
<form class='form-group' action="newpass.php" method="POST">
        <h1 class="index-h1">Смена пароля</h1>
    ...
    <p><input type="password" name="password" placeholder="Ваш старый пароль"></p>
