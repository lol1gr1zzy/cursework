...
<body>
    <h1 class="index-h1">Вход в ЛК</h1>
    ...
    <br><button type="submit" class="btn btn-primary mb-2">Enter</button></br>
    <strong><?php session_start();
        echo $_SESSION['msg'];
        unset($_SESSION['msg']);
    ?></strong>
    </form>
    <p><a class="forget" href = "forgetpass.php" class = "forgetpass"> Забыли пароль? </a> </p>
